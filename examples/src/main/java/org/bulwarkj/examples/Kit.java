...
package org.bulwarkj.examples;

import org.bulwarkj.core.*;
import org.bulwarkj.kits.WalletAppKit;
...
/**
 * The following example shows how to use the by bulwarkj provided WalletAppKit.
 * The WalletAppKit class wraps the boilerplate (Peers, BlockChain, BlockStorage, Wallet) needed to set up a new SPV bulwarkj app.
 * 
...
public class Kit {
    ...
    public static void main(String[] args) {
        ...
        // bulwarkj is working a lot with the Google Guava libraries. The WalletAppKit extends the AbstractIdleService. Have a look at the introduction to Guava services: https://github.com/google/guava/wiki/ServiceExplained
        kit.startAsync();
        kit.awaitRunning();
