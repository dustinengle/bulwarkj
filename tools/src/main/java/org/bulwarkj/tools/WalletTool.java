...
package org.bulwarkj.tools;

import org.bulwarkj.core.*;
import org.bulwarkj.crypto.*;
import org.bulwarkj.net.discovery.DnsDiscovery;
import org.bulwarkj.params.MainNetParams;
import org.bulwarkj.params.RegTestParams;
import org.bulwarkj.params.TestNet3Params;
import org.bulwarkj.protocols.payments.PaymentProtocol;
import org.bulwarkj.protocols.payments.PaymentProtocolException;
import org.bulwarkj.protocols.payments.PaymentSession;
import org.bulwarkj.script.ScriptBuilder;
import org.bulwarkj.store.*;
import org.bulwarkj.uri.BulwarkURI;
import org.bulwarkj.uri.BitcoinURIParseException;
import org.bulwarkj.utils.BriefLogFormatter;
import org.bulwarkj.wallet.DeterministicSeed;
import org.bulwarkj.wallet.DeterministicUpgradeRequiredException;
import org.bulwarkj.wallet.DeterministicUpgradeRequiresPassword;
...
import org.bulwarkj.core.listeners.BlocksDownloadedEventListener;
import org.bulwarkj.core.listeners.DownloadProgressTracker;
import org.bulwarkj.wallet.MarriedKeyChain;
import org.bulwarkj.wallet.Protos;
import org.bulwarkj.wallet.SendRequest;
import org.bulwarkj.wallet.Wallet;
import org.bulwarkj.wallet.WalletExtension;
import org.bulwarkj.wallet.WalletProtobufSerializer;
import org.bulwarkj.wallet.Wallet.BalanceType;
...
import static org.bulwarkj.core.Coin.parseCoin;
        ...
        if (location.startsWith("http") || location.startsWith(CoinDefinition.coinURIScheme)) {
            try {
                ...
                if (location.startsWith("http")) {
                    ...
                    BulwarkURI paymentRequestURI = new BulwarkURI(location);
