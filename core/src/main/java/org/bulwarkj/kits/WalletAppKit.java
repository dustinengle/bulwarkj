...
import org.bulwarkj.protocols.channels.*;
import org.bulwarkj.store.*;
import org.bulwarkj.wallet.*;
import org.slf4j.*;
...
/**
 * <p>Utility class that wraps the boilerplate needed to set up a new SPV bulwarkj app. Instantiate it with a directory
 ...
 * It is to make it easier to fit bulwarkj into GUI apps, which require a high degree of responsiveness on their main
 * thread which handles all the animation and user interaction. Even when blockingStart is false, initializing bulwarkj
...
public class WalletAppKit extends AbstractIdleService {
    ...
    public WalletAppKit(Context context, File directory, String filePrefix) {
        ...
        context.initBulwark(false, true);
     ...
     * {@link org.bulwarkj.core.DownloadProgressTracker} is a good choice. This has no effect unless setBlockingStartup(false) has been called
     ...
     * block sync faster for new users - please refer to the documentation on the bulwarkj website for further details.
     */
