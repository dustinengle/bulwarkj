...
public class BasicKeyChain implements EncryptableKeyChain {
     ...
     * @throws org.bulwarkj.wallet.UnreadableWalletException.BadPassword if the password doesn't seem to match
     * @throws org.bulwarkj.wallet.UnreadableWalletException if the data structures are corrupted/inconsistent
     */
    ...
    /**
     * Convenience wrapper around {@link #toEncrypted(org.bulwarkj.crypto.KeyCrypter,
