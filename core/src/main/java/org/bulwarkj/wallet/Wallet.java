...
import org.bulwarkj.core.*;
import org.bulwarkj.core.Message;
import org.bulwarkj.core.listeners.*;
import org.bulwarkj.core.TransactionConfidence.*;
import org.bulwarkj.crypto.*;
import org.bulwarkj.script.*;
import org.bulwarkj.signers.*;
import org.bulwarkj.utils.*;
import org.bulwarkj.wallet.Protos.Wallet.*;
import org.bulwarkj.wallet.WalletTransaction.*;
import org.bulwarkj.wallet.listeners.KeyChainEventListener;
import org.bulwarkj.wallet.listeners.ScriptsChangeEventListener;
import org.bulwarkj.wallet.listeners.WalletChangeEventListener;
import org.bulwarkj.wallet.listeners.WalletCoinsReceivedEventListener;
import org.bulwarkj.wallet.listeners.WalletCoinsSentEventListener;
import org.bulwarkj.wallet.listeners.WalletEventListener;
import org.bulwarkj.wallet.listeners.WalletReorganizeEventListener;
import org.slf4j.*;
 ...
 * {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, org.bulwarkj.wallet.WalletFiles.Listener)}
...
public class Wallet extends BaseTaggableObject
    ...
    private Wallet(Context context, KeyChainGroup keyChainGroup) {
        ...
        //this.version = this.keyChainGroup.getActiveKeyChain().getKeyChainType() == DeterministicKeyChain.KeyChainType.BIP44_BULWARK_ONLY? 1 : 0;
     ...
     * {@link org.bulwarkj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS}. The returned key is stable until
    ...
    /**
     * An alias for calling {@link #currentKey(org.bulwarkj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.bulwarkj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #currentKey(org.bulwarkj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #currentAddress(org.bulwarkj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.bulwarkj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * {@link org.bulwarkj.wallet.DeterministicKeyChain}. When the parameter is
     * {@link org.bulwarkj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} the returned key is suitable for being put
    ...
    /**
     * An alias for calling {@link #freshKey(org.bulwarkj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.bulwarkj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #freshKey(org.bulwarkj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #freshAddress(org.bulwarkj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.bulwarkj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * key, after loading a wallet produced by previous versions of bulwarkj. If the wallet is encrypted the key
     ...
     * If {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, org.bulwarkj.wallet.WalletFiles.Listener)}
    ...
    /** See {@link org.bulwarkj.wallet.DeterministicKeyChain#setLookaheadSize(int)} for more info on this. */
    ...
    /** See {@link org.bulwarkj.wallet.DeterministicKeyChain#setLookaheadThreshold(int)} for more info on this. */
     ...
     * See {@link org.bulwarkj.wallet.DeterministicKeyChain#markKeyAsUsed(DeterministicKey)} for more info on this.
     */
     ...
     * @throws org.bulwarkj.core.ECKey.MissingPrivateKeyException if the seed is unavailable (watching wallet)
     */
    ...
    /**
     * Convenience wrapper around {@link Wallet#encrypt(org.bulwarkj.crypto.KeyCrypter,
     ...
     * {@link org.bulwarkj.crypto.KeyCrypterScrypt}.
     *
     ...
     * of {@link org.bulwarkj.core.ECKey#getCreationTimeSeconds()}. This can return zero if at least one key does
     ...
     * you can use {@link org.bulwarkj.utils.Threading#waitForUserCode()} to block until the future had a
    ...
    public enum MissingSigsMode {
        ...
        USE_DUMMY_SIG,
        /**
         * If signature is missing, {@link org.bulwarkj.signers.TransactionSigner.MissingSignatureException}
     ...
     */
    public void setTransactionBroadcaster(@Nullable org.bulwarkj.core.TransactionBroadcaster broadcaster) {
     ...
     * @throws org.bulwarkj.wallet.DeterministicUpgradeRequiresPassword if key rotation requires the users password.
     */
