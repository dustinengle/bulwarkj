...
/**
 * <p>A KeyChainGroup is used by the {@link org.bulwarkj.wallet.Wallet} and
...
public class KeyChainGroup implements KeyBag {
     ...
     *
     * @throws org.bulwarkj.crypto.KeyCrypterException Thrown if the wallet encryption fails for some reason,
     ...
     * KeyCrypter to use is {@link org.bulwarkj.crypto.KeyCrypterScrypt}.
     *
     * @throws org.bulwarkj.crypto.KeyCrypterException Thrown if the wallet decryption fails for some reason, leaving the group unchanged.
     */
