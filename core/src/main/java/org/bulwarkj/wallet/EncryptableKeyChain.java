...
import org.bulwarkj.crypto.KeyCrypterException;
...
public interface EncryptableKeyChain extends KeyChain {
     ...
     * {@link #toEncrypted(org.bulwarkj.crypto.KeyCrypter, org.spongycastle.crypto.params.KeyParameter)} with
     * {@link org.bulwarkj.crypto.KeyCrypterScrypt} as the crypter.
     *
     ...
     * {@link org.bulwarkj.wallet.SendRequest#aesKey} field before asking the wallet to build the send.
     *
