 ...
 * the lightweight SPV mode, a {@link org.bulwarkj.store.SPVBlockStore} is the right choice.</p>
 *
 ...
 * {@link org.bulwarkj.store.H2FullPrunedBlockStore} implements full verification, which is equivalent to
