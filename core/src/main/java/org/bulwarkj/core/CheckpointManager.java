...
import org.bulwarkj.store.FullPrunedBlockStore;
 ...
 * {@link org.bulwarkj.store.SPVBlockStore}s. They are not used by fully validating mode, which instead has a
...
public class CheckpointManager {
    ...
    /** Loads the default checkpoints bundled with bulwarkj */
    ...
    /** Returns a checkpoints stream pointing to inside the bulwarkj JAR */
