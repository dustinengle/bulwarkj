...
import org.bulwarkj.net.discovery.HttpDiscovery;
import org.bulwarkj.params.*;
import org.bulwarkj.script.Script;
import org.bulwarkj.script.ScriptBuilder;
import org.bulwarkj.script.ScriptChunk;
import org.bulwarkj.script.ScriptOpCodes;
...
import org.bulwarkj.utils.VersionTally;
...
public abstract class NetworkParameters {
    ...
    public static final String ID_REGTEST = "org.bulwark.regtest";
    ...
    /** Returns discovery objects for seeds implementing the Cartographer protocol. See {@link org.bulwarkj.net.discovery.HttpDiscovery} for more info. */
    ...
    /**
     * First byte of a base58 encoded address. See {@link org.bulwarkj.core.Address}. This is the same as acceptableAddressCodes[0] and
    ...
    /** First byte of a base58 encoded dumped private key. See {@link org.bulwarkj.core.DumpedPrivateKey}. */
    ...
    /**
     * The key used to sign {@link org.bulwarkj.core.AlertMessage}s. You can use {@link org.bulwarkj.core.ECKey#verify(byte[], byte[], byte[])} to verify
     * signatures using it.
     */
