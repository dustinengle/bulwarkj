...
import org.bulwarkj.net.AbstractTimeoutHandler;
import org.bulwarkj.net.MessageWriteTarget;
 ...
 * {@link org.bulwarkj.net} classes and {@link Peer}.
 */
public abstract class PeerSocketHandler extends AbstractTimeoutHandler implements StreamConnection {
     ...
     * called automatically by {@link org.bulwarkj.net.NioClient} or
     * {@link org.bulwarkj.net.NioClientManager} once the socket finishes initialization.
     */
    @Override
