...
import org.bulwarkj.net.StreamConnection;
import org.bulwarkj.store.BlockStore;
import org.bulwarkj.store.BlockStoreException;
import org.bulwarkj.utils.ListenerRegistration;
 ...
 * {@link org.bulwarkj.net.AbstractTimeoutHandler} and timeout is automatically disabled (using
 * {@link org.bulwarkj.net.AbstractTimeoutHandler#setTimeoutEnabled(boolean)}) once the version
...
public class Peer extends PeerSocketHandler {
     ...
     * {@link org.bulwarkj.net.NioClientManager#openConnection(java.net.SocketAddress, StreamConnection)}
     * or
     * {@link org.bulwarkj.net.NioClient#NioClient(java.net.SocketAddress, StreamConnection, int)}.</p>
     *
    ...
    /**
     * <p>Construct a peer that reads/writes from the given block chain. Transactions stored in a {@link org.bulwarkj.core.TxConfidenceTable}
    ...
    protected void processMessage(Message m) throws Exception {
        ...
        else if(m instanceof SporkMessage)
        {
            ...
            // todo furszy: check bulwark masternodes
    ...
    private void processVersionMessage(VersionMessage m) throws ProtocolException {
        ...
        // bulwarkj is a client mode implementation. That means there's not much point in us talking to other client
...
//            if(!instantSend.mapTxLockVotes.containsKey(item.hash))
     ...
     * Once the pong is received the value returned by {@link org.bulwarkj.core.Peer#getLastPingTime()} is
     * updated.
    ...
    /**
     * Returns the elapsed time of the last ping/pong cycle. If {@link org.bulwarkj.core.Peer#ping()} has never
    ...
    /**
     * Returns a moving average of the last N ping/pong cycles. If {@link org.bulwarkj.core.Peer#ping()} has never
