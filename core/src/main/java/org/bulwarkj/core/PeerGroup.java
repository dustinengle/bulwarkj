...
import org.bulwarkj.net.*;
import org.bulwarkj.net.discovery.*;
...
public class PeerGroup implements TransactionBroadcaster {
     ...
     * FP rate is chosen for performance rather than privacy. If a future version of bulwarkj fixes the known
     ...
     * {@link org.bulwarkj.core.listeners.PeerConnectionEventListener} and use the onPeerConnected/onPeerDisconnected methods.
     */
     ...
     *         Use {@link org.bulwarkj.core.Peer#getConnectionOpenFuture()} if you
     ...
     * peers. By using this with {@link org.bulwarkj.core.PeerGroup#getMaxConnections()} you can wait until the
     ...
     * {@link org.bulwarkj.core.PeerGroup#getMaxConnections()} returns is used.
     */
    ...
    /**
     * See {@link org.bulwarkj.core.PeerGroup#getMinBroadcastConnections()}.
     */
     ...
     * {@link org.bulwarkj.core.TransactionBroadcast#future()} method will be completed. If anything goes
     ...
     *
     * <p>The returned {@link org.bulwarkj.core.TransactionBroadcast} object can be used to get progress feedback,
     ...
     * times are available via {@link org.bulwarkj.core.Peer#getLastPingTime()} but it increases load on the
     ...
     * using {@link org.bulwarkj.core.Peer#ping()}.
     */
     ...
     * and easy way for a user to upgrade a bulwarkj based app running in SPV mode to fully validating security.
     */
