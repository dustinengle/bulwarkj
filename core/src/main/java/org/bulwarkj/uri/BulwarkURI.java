...
import org.bulwarkj.params.AbstractBitcoinNetParams;
...
public class BulwarkURI {
    ...
    /**
     * URI for Bitcoin network. Use {@link org.bulwarkj.params.AbstractBitcoinNetParams#BITCOIN_SCHEME} if you specifically
     * need Bitcoin, or use {@link org.bulwarkj.core.NetworkParameters#getUriScheme} to get the scheme
    ...
    /**
     * Constructs a new BulwarkURI from the given string. Can be for any network.
     *
     ...
     */
    public BulwarkURI(String uri) throws BitcoinURIParseException {
        this(null, uri);
    }
     ...
     */
    public BulwarkURI(@Nullable NetworkParameters params, String input) throws BitcoinURIParseException {
        checkNotNull(input);
    ...
    public String toString() {
        StringBuilder builder = new StringBuilder("BulwarkURI[");
        boolean first = true;
