...
import org.bulwarkj.core.VerificationException;
import org.bulwarkj.core.TransactionConfidence.ConfidenceType;
import org.bulwarkj.crypto.*;
import org.bulwarkj.script.Script;
import org.bulwarkj.script.ScriptBuilder;
import org.bulwarkj.signers.StatelessTransactionSigner;
import org.bulwarkj.signers.TransactionSigner;
import org.bulwarkj.store.BlockStoreException;
import org.bulwarkj.store.MemoryBlockStore;
import org.bulwarkj.testing.*;
import org.bulwarkj.utils.ExchangeRate;
import org.bulwarkj.utils.Fiat;
import org.bulwarkj.utils.Threading;
import org.bulwarkj.wallet.Wallet.BalanceType;
import org.bulwarkj.wallet.WalletTransaction.Pool;
...
import org.bulwarkj.wallet.Protos.Wallet.EncryptionType;
...
import static org.bulwarkj.core.Utils.HEX;
import static org.bulwarkj.testing.FakeTxBuilder.*;
...
public class WalletTest extends TestWithWallet {
    ...
    public void doubleSpends() throws Exception {
        ...
        buf[43] = 0;  // Break the signature: bulwarkj won't check in SPV mode and this is easier than other mutations.
    ...
    public void autosaveImmediate() throws Exception {
        ...
        File f = File.createTempFile("bulwarkj-unit-test", null);
