...
import org.bulwarkj.crypto.LazyECPoint;
import org.bulwarkj.crypto.MnemonicCode;
import org.bulwarkj.crypto.MnemonicException;
import org.bulwarkj.net.discovery.PeerDiscovery;
import org.bulwarkj.net.discovery.PeerDiscoveryException;
...
public class MatiTest {
    ...
    public void accountDetailsTest(){
        ...
        Wallet wallet = Wallet.fromSeed(
                networkParameters,
                seed,
                DeterministicKeyChain.KeyChainType.BIP44_BULWARK_ONLY
        );
    ...
    public Wallet restore(NetworkParameters networkParameters) throws IOException {
        String filename = "2.0.32_bulwark-wallet-backup_org.bulwark.production-2017-11-20";
        //"1.01_bulwark-wallet-backup_org.bulwark.production-2017-07-26 (2)";
    ...
    public void watchOnlyTest(){
        ...
        Wallet watchingWallet = Wallet.fromWatchingKeyB58(networkParameters,xpub,0, DeterministicKeyChain.KeyChainType.BIP44_BULWARK_ONLY);
